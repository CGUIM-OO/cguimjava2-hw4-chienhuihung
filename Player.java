...
public class Player {
		...
		private ArrayList<Card> oneRoundCard;//oneRoundCard參數
    ...
    public Player(String name, int chips){//把player的名字傳入和chips傳入
		...
		public String getName(){//getName()的方法
			return name;}
		public int makeBet(){//makeBet()下注的方法
		...
		public int getCurrentChips(){//取得現在的clips
			return chips;
		}
		public void increaseChips (int diff){//chips的改變
			chips=chips+diff;
		}
		public void sayHello(){//sayHello的方法
